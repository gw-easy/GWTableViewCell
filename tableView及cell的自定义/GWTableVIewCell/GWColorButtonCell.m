...
#import "GWColorButtonCell.h"
#import "UIView+GW.h"
#import "GWCommonTableData.h"

@interface GWColorButtonCell()

@property (nonatomic,strong) GWCommonTableRow *rowData;

@end

@implementation GWColorButtonCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        self.backgroundColor = [UIColor clearColor];
        _button = [[GWColorButton alloc] initWithFrame:CGRectZero];
...
@implementation GWColorButton : UIButton
